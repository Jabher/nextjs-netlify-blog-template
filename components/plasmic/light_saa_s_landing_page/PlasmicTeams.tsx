...
import sty from "./PlasmicTeams.module.css"; // plasmic-import: OuWahErWzO4I-H/css
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p.Trans>{"Founder Flappin"}</p.Trans>
        </div>
        <div
          className={classNames(
            projectcss.all,
