...
import sty from "./PlasmicButton.module.css"; // plasmic-import: zzLIFts1LagP3q/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__hw9X)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__cngKu)}
                role={"img"}
              />
            ),
